...
def student_attendance(request):
    ...
    if request.method == 'POST':
        ...
        # Check attendance percentage for the 6th day
        alert_message = None
        if total_days >=6 and overall_percentage is not None and overall_percentage < 75:
            ...
            from_email = 'kiranhs8577@gmail.com'  # Replace with your email address or use a valid email address from which to send
            email = student.email
